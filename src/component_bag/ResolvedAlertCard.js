...
export default class ResolvedAlertCard extends Component {
    constructor(props){
        super(props)
        this.state = {
            popUpState:false,
    ...
    render() {
        return (
            <div 
                ...
                style={{ marginBottom:20, backgroundColor:"#DFEFE0", fontFamily:fontFamily3}} className='width-90-cent curved-corners position-relative padding-20 a-center height-80 min-height-60 elevated-blend'
            >
                <div className='width-auto a-center height-100-cent'>
                    <CheckCircleIcon style={{marginRight:30, color:"#71B777"}}/>
                ...
                <div className='width-100-cent a-center margin-l-30 height-100-cent'>
                    <LocationOnIcon style={{color:"#71B777"}}/>
