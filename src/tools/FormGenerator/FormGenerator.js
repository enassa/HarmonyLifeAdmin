...
class FormGenerator extends Component {
    ...
    getTimeInterval = (field,index) => {
       ...
       let  setTimeTinterval = (timeType,time) => {
            ...
            this.props.removeButton?this.handleSelect(time,field):this.handleOnChange(time,field)
        }
        return <div key={index} 
                className={mod("form__group")}    
                style={{width:"100%",display:"flex",alignItems:"center", height:"80px"}}>
    ...
    getSelectFields = (fields,index) => {
        ...
        return <div 
                    style={{display:"flex", width:"100%", justifyContent:"space-between",borderBottom: "1px solid #d2d2d2"}}
                    // style={{display:"flex", width:"100%", flexFlow:"column", borderRadius:20, borderLeft:`${this.state.activeQuestion===value?'5px solid blue':""}`}} 
                ...
                <select multiple={fields.multiple?fields.multiple:false} name={fields.name} style={{ backgroundColor:"transparent", color: "rgb(155, 155, 155)", marginTop: 20,fontFamily: "Helvetica Neue",fontSize: this.state.fontSize, fontWeight: 300}} className='width-100-cent border-0 outline-none'
    ...
    const {buttonType} = this.props;
            ...
            <div id={mod("main-form-container")} style={outerStyle}>
                 {this.state.confirmation
                    ...
                    <div className='slide-up nate-blue-text max-width-400 width-80-cent position-relative a-center f-column j-center height-200 curved-corners nate-white-bg'>
                        <span style={{fontFamily:fontFamily3, fontSize:20, fontWeight:300, color:"", }}>Confirm form submission?</span>
                        <span className=' width-100-cent bottom-0 right-0 j-end position-absolute padding-r-20 padding-b-20'>
                            ...
                            <span 
                                ...
                                style={{fontFamily:fontFamily3, fontSize:20, fontWeight:300, }}
                            ...
                            <span 
                                ...
                                style={{fontFamily:fontFamily3, fontSize:20, fontWeight:300, color:"", }}                                
                                className='cursor-pointer'>
                                    Submit
                            </span>
                    </span>
        ...
        :null
                ...
                ?<div className='nate-pink-text nate-font-1'>Sorry, login was unsuccessful</div>
                :null
                }
            </div>
        );
