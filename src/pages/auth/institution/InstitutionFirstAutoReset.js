...
import { getTodaysDateWithoutDash, getParameterByName, decodeFromB64 } from '../../../contants/generalFunctions';
...
import { inntialResetInstitutionPassword } from '../../../store/actions/institutionsActions';
let decodedEmail = undefined;
class InstitutionFirstAutoReset extends Component {
    constructor(props){
        super(props)
        this.state = {
            typeOfUser:null,
    ...
    handleSubmit= (data,resetForm,completed)=>{
        ...
        let myData = {...data, username:decodedEmail}
        // const myData = {
        //     'email':data.email?data.email:null,
        //     'password':data.password?data.password:null,
        // }
        // this.props.history.push('/mtn/agent/admin')
        this.props.inntialResetInstitutionPassword(myData) 
        ...
        return (
            <div className='width-100-cent height-100-cent nate-grey-bg all-center nate-white-bg f-column j-start a-center'>
                ...
                >
                    ...
                    <div style={{fontSize:20,fontFamily:fontFamily5}} className='all-center'><Lock/>Org. Password Reset</div>
...
const mapDispatchToProps = (dispatch) => { 
    return {
        ...
        inntialResetInstitutionPassword: (data) => dispatch(inntialResetInstitutionPassword(data)),
...
export default connect(mapStateToProps,mapDispatchToProps)(InstitutionFirstAutoReset)