...
import { getTodaysDateWithoutDash, getParameterByName } from '../../../contants/generalFunctions';
...
class InstitutionPasswordReset extends Component {
    constructor(props){
        super(props)
        this.state = {
            typeOfUser:null,
...
export default connect(mapStateToProps,mapDispatchToProps)(InstitutionPasswordReset)