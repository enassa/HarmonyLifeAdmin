...
class InstitutionEmailVerification extends Component {
    constructor(props){
        super(props)
        this.state = {
            typeOfUser:null,
    ...
    handleSubmit= (data,resetForm,completed)=>{
        ...
        // }
        this.props.history.push('/institution/reset')
        ...
        return (
            <div className='width-100-cent height-100-cent nate-grey-bg all-center nate-white-bg f-column j-start a-center'>
                ...
                >
                    ...
                    <div style={{borderTop:"2px solid black "}} className='width-400 height-200 curved-corners j-space-around a-center f-column  nate-white-bg elevated-blend padding-30'>
                    <div style={{fontSize:20,fontFamily:fontFamily5}} className='all-center'>Org. Email Verification</div>
...
export default connect(mapStateToProps,mapDispatchToProps)(InstitutionEmailVerification)