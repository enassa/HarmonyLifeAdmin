...
class FacilityEmailVerification extends Component {
    constructor(props){
        super(props)
        this.state = {
            typeOfUser:null,
    ...
    handleSubmit= (data,resetForm,completed)=>{
        ...
        // }
        this.props.history.push('/facility/reset')
        ...
        return (
            <div className='width-100-cent height-100-cent nate-grey-bg all-center nate-white-bg f-column j-start a-center'>
                ...
                >
                    ...
                    <div style={{fontSize:20,fontFamily:fontFamily5}} className='all-center'>Email Verification</div>
...
export default connect(mapStateToProps,mapDispatchToProps)(FacilityEmailVerification)