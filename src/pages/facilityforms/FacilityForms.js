...
export default class FacilityForms extends Component {
 constructor(props){
     super(props)
     this.state = {
  ...
  render() {
    return <div style={{fontFamily:fontFamily3,fontSize:30, fontWeight:300}} className='width-100-cent f-column height-100-cent all-center'>
          ...
          <div style={{color:"grey", fontSize:50,fontWeight:"bolder",fontFamily:fontFamily5}} 
            ...
            <div>Click start to create a facility for  
                ...
                <span style={{color:this.getColor(), fontWeight:"bolder",fontFamily:fontFamily5,marginLeft:10, color:"#FFCC01"}}>MTN</span></div>
